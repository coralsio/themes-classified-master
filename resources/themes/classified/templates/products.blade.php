        ...
        <div class="container">
            @php
                if (!is_null(\Request::get('user'))){
                    $productUser = getUserByHash(\Request::get('user'));
                }
            @endphp
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12 col-xs-12 page-content">
                    ...
                    <div class="product-filter">
                        ...
                        <div class="Show-item">
                            <label
                                for="sorting">@lang('corals-classified-master::labels.template.product.sort_by')</label>
                            <label>
                                <select name="order" class="orderby form-control" id="product_sort">
                                    ...
                                    @foreach($sortOptions as $value => $text)
                                        <option
                                            value="{{ $value }}" {{ request()->get('sort') == $value?'selected':'' }}>
                                            {{ $text }}
                                        </option>
                                    @endforeach
                                </select>
